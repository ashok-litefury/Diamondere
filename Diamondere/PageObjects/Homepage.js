...
class Homepage {
    ...
    get bscharms() {
        return $('//div[@class="subtitle-font menu-filter-icon-header charms-new"]s')
    }
    ...
    get optnToiEtMoiRings() {
        return $('//a[@title="Toi et Moi Collection"]//p[contains(text(),"Shop Now")]')
    }
    get optnVintageRings() {
        return $('//a[@title="Vintage Rings"]//p[contains(text(),"Shop Now")]')
    }
    ...
    shopBlackGoldMen() {
        ElementUtil.scrollIntoView(this.optnBlackGoldMenRings, "click BG men rings")
    ...
    clickDisclaimer(){
        ElementUtil.scrollIntoView(this.sctnFooter, "Scroll to copyright sction")
