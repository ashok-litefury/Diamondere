...
//BANNERS
    ...
    get LooseDiamondsDDPBanner() {
        return $('//h1[@class="is-uppercase is-size-6-mobile m-b-5-mob" and text()="Loose diamonds"]')
    }
...
//HEADING TAB
    ...
    get tabDiamondActive() {
        return $('//div[@class="myoj-nav-icons diamond"]//parent::div//parent::div[@class="has-text-info arrow arrow1 is-active-tab cur-no-drop"]')
    }
    ...
    get imgRingIcon() {
        return $('//div[@class="myoj-nav-icons ring"]')
    }

    get imgEarringIcon() {
        return $('//div[@class="myoj-nav-icons earring"]')
    }

    get imgNecklaceIcon() {
        return $('//div[@class="myoj-nav-icons necklace"]')
    }

    get imgMensRingIcon() {
        return $('//div[@class="myoj-nav-icons men"]')
    }
    ...
    get imgWomensBandIcon() {
        return $('//div[@class="myoj-nav-icons women"]')
    }
...
// REQUEST CUSTOM ORDER
    ...
    selectRingsSwad() {
        ...
        BrowserUtil.wait(5)
        ElementUtil.waitForDisplayed(this.ringStartWithDiamondBanner, 10, "Wait for page load")
    }

    selectEngagementSwad() {
        ElementUtil.click(this.ownEngstartwithdiamond, "Click Start with a Diamond - Engagement")
        BrowserUtil.wait(5)
        ElementUtil.waitForDisplayed(this.engagementSWADBanner, 10, "Wait for page load")
    }

    selectEarringsSwad() {
        ElementUtil.click(this.ownEarstartwithdiamond, "Click Start with a Diamond - Earrings")
        BrowserUtil.wait(5)
        ElementUtil.waitForDisplayed(this.earringsSWADBanner, 10, "Wait for page load")
    }

    selectNecklacesSwald() {
        ElementUtil.click(this.oNeckstartwithlabdiamond, "Click Start with a Lab Diamond - Necklaces")
        BrowserUtil.wait(5)
        ElementUtil.waitForDisplayed(this.necklacesSWLDBanner, 10, "Wait for page load")
    }

    selectMensSwald() {
        ElementUtil.click(this.oMenstartwithlabdiamond, "Click Start with a Lab Diamond - Men's")
        BrowserUtil.wait(5)
        ElementUtil.waitForDisplayed(this.mensSWLDBanner, 10, "Wait for page load")
    }
    ...
    selectDecrementLength() {
        ElementUtil.waitForEnabled(this.lengthrightbox, 50, "wait for page load")
        ElementUtil.click(this.lengthrightbox, "Clicking max length box")
        browser.keys(['ArrowDown'])
        BrowserUtil.wait(5)
    }
    ...
    selectViewLabDiamond() {
        ElementUtil.click(this.viewlabdiamondbutton, "Click View Lab Diamond Button")
        BrowserUtil.wait(8);
    }
    ...
    hoverViewDetailsDiamondFeatures() {
        ElementUtil.scrollIntoView(this.btnSelectMensRing, "Scroll to Diamond Details")
        ElementUtil.mouseHover(this.txtColorDDP, "Hover over Color")
        ...
        ElementUtil.click(this.popupBtnXDiamondDetail, "Click X button")
        ElementUtil.mouseHover(this.txtCutDDP, "Hover over Cut")
        ElementUtil.click(this.cutViewDetailsDDP, "Click View Details")
    ...
    clicksubmitCustom() {
        ElementUtil.click(this.btnsubmitrequestcustom, "click submit request")
    }
    uploadImageCustom() {
        ElementUtil.uploadFile(this.inputFile, this.btnuploadimagecustom, imageJpg, "Uploading image")
    }
    uploadWrongImageCustom() {
        ElementUtil.uploadFile(this.inputFile, this.btnuploadimagecustom, imagePng, "Uploading wrong image")
    }
