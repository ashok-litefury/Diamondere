...
class CustomerAssistance {
    ...
    get msgErrorEmailAddress() {
        return $ ('//div[text()="This email cannot be added to this list. Please enter a different email address."]')
    }
    ...
    enterInvalidNameRCB() {
        ...
        ElementUtil.clearText(this.txtBoxName, "Clearing text")
    ...
    enterInvalidEmailRCB() {
        ...
        ElementUtil.clearText(this.txtBoxEmail, "Clearing text")
    ...
    uploadImage() {
        ElementUtil.uploadFile(this.inputFile, this.btnUploadImage, imageJpg, "Uploading image")
    }
    ...
    uploadInvalidImageFormat() {
        ElementUtil.uploadFile(this.inputFile, this.btnUploadImage, imagePng, "Uploading invalid image format")
    }
    ...
    enterEmailJoinDmd() {
        ElementUtil.sendText(this.txtBoxEmailAddress, data.JoinDiamondereCommunity.Email, "Enter email")
    }
    ...
    enterInvalidEmailJoinDmd() {
        ...
        ElementUtil.clearText(this.txtBoxEmailAddress, "Clearing text")
    ...
    enterInvalidNameJoinDmd() {
        ...
        ElementUtil.isVisible(this.msgInvalidName, "Check invalid name message")
        ElementUtil.clearText(this.txtBoxFirstName, "Clearing text")
    ...
    enterInvalidBirthDayJoinDmd() {
        ...
        ElementUtil.clearText(this.txtBoxBirthMonth, "Clearing text")
        ...
        ElementUtil.isVisible(this.msgInvalidBirthday, "Check invalid birthday message")
        ElementUtil.clearText(this.txtBoxBirthDate, "Clearing text")
    ...
    enterInvalidYourName() {
        ...
        ElementUtil.isVisible(this.msgInvalidName, "Check invalid name message")
        ElementUtil.clearText(this.txtBoxYourName, "Clearing text")
    ...
    enterInvalidYourFriendName() {
        ...
        ElementUtil.isVisible(this.msgInvalidName, "Check invalid name message")
        ElementUtil.clearText(this.txtBoxYourFriendName, "Clearing text")
    ...
    enterInvalidYourEmail() {
        ...
        ElementUtil.isVisible(this.msgInvalidEmail, "Check invalid email message")
        ElementUtil.clearText(this.txtBoxYourEmail, "Clearing text")
    ...
    enterInvalidYourFriendEmail() {
        ...
        ElementUtil.isVisible(this.msgInvalidEmail, "Check invalid email message")
        ElementUtil.clearText(this.txtBoxYourFriendEmail, "Clearing text")
