...
class RegistrationandLogin {
    ...
    get shpbagSC(){
        return $('//span[@class="cart-badge" and text()="2"]')
    }
...
/////////////////////////////////////////////////////////////////////////
    ...
    enterRegFields(){
        ...
        ElementUtil.sendText(this.txtBoxEmail,data.RegandLoginlinks.RegistrationEmail,"Enter email")
    ...
    entervalidEmailLogin(){
        ...
        ElementUtil.sendText(this.loginEmail,data.RegandLoginlinks.InvalidPW," enter invalid PW")
    }
    clickForgotPWLink(){
