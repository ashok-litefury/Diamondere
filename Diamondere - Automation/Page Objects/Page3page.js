...
get imgyellowbox(){
    return $('//div[@class="chain-box-yellow selected-chain chain-design-icon is-clickable"]')
}
get txtcable(){
...
get imgyellowcable(){
    return $('//div[@class="chain-cable-yellow chain-design-icon cable-chain is-clickable"]')
}
get btn16InchChain(){
...
get setting18ktwhitegold(){
    return('//div[@class="product-details" and contains(text(), "METAL")]/br/following-sibling::text()[normalize-space()="18k White Gold"]')
}
...
clicklnkmoneyguarantee(){
    ElementUtil.click(this.lnkMoneyBackGuarantee,"click money guarantee")
}
clicklnkwarranty(){
