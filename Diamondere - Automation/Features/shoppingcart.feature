Feature: Testing Shoppingcartpage of Diamondere
    ...
    #         And I select a product in page 2
    #         Then I ensure product area in shoppingcart is displayed
    #         #Then I ensure jazmin product image in shoppingcart is displayed
    #         #Then I ensure remove button is displayed below product image
    #         #Then I ensure jazmin product name in shoppingcart is displayed
    #         #Then I ensure jazmin product description in shoppingcart is displayed
    #         #Then I ensure ring size text for ring is displayed
    #         #Then I ensure selected jazmin ringsize is displayed
    #         Then I ensure 100 days return text is displayed
    #         Then I ensure 100 days return text is displayed
    #         Then I ensure product price is displayed
    #         #Then I ensure show discount details link is displayed
    ...
    Scenario: Checking mens band product in shopping cart page
        ...
        Then I ensure product area in shoppingcart is displayed
        #Then I ensure colt product image in shoppingcart is displayed
        #Then I ensure remove button is displayed below product image
        #Then I ensure colt product name in shoppingcart is displayed
        #Then I ensure colt product description in shoppingcart is displayed
        #Then I ensure ring size text for ring is displayed
        #Then I ensure selected colt ringsize is displayed
        #Then I ensure bandwidth text for ring is displayed
        #Then I ensure selected colt bandwidth is displayed
        Then I ensure 100 days return text is displayed
        Then I ensure 100 days return text is displayed
        Then I ensure add protection text is displayed
        Then I ensure 3,5,lifetime buttons are displayed
    ...
    #16(1)
    Scenario: dimaond moved to shopping cart
        Given I browse Start with a Diamond page of Rings menu
