...
Given(/^I click the shop now link under Pink Tourmaline rings$/, () => {
	const shopnatural = new Homepage;
...
Given(/^I click the shop now link under Morganite rings$/, () => {
	const shopnatural = new Homepage;
...
Given(/^I click the shop now link under Peridot rings$/, () => {
	const shopnatural = new Homepage;
...
Given(/^I click the shop now link under Alexandrite rings$/, () => {
	const shopnatural = new Homepage;
    shopnatural.pinkTourDiaRings();
});
...
Given(/^I click the shop now link under Aquamarine rings$/, () => {
	const shopnatural = new Homepage;
